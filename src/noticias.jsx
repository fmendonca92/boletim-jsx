...
const Noticias = () => (
    <div>
        <h2 className='titulo-secao'>Notícias de Primeira</h2>
        <div className='noticia-x-geral'>
            <span className="titulo-noticia-x">FÉRIAS PASTORAIS</span>
        ...
        <div className='noticia-x-geral'>
            ...
            <span className="titulo-noticia-x"> </span>
            <span className="corpo-noticia-x">Nos dias 13 e 14/09 acontecerá a 3º Conferência do Completo em Cristo. Falta menos de um mês para este evento. Se você ainda não se inscreveu, não perca tempo, as vagas estão esgotando. Os temas que serão expostos são para edificação de todo corpo de Cristo, por isso, apesar do ministério ser voltado para o público solteiro, viúvo e divorciado, o casado também pode participar da conferência. </span>
        </div>
